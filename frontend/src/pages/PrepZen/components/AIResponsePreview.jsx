    ...
    <div className="max-w-4xl mx-auto">
        ...
        <ReactMarkdown
          ...
          components={{
            ...
            p({ children }) {
                return <p className="mb-2 leading-5">{children}</p>;
            },
            strong({ children }) {
            ...
            blockquote({ children }) {
                return <blockquote className="border-l-4 border-gray-200 pl-4 italicm y-4">{children}</blockquote>;
            },
            h1({ children }) {
    ...
    return <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
        <div className="flex items-center justify-between bg-gray-100 px-4 py-2 border-b border-gray-200">
            ...
            <button
                ...
                { copied && (
                    <span className="absolute -top-8 right-0 bg-black text-white text-xs rounded-md px-2 py-1 opacity-0 group-hover:opacity-100 transition">
                    Copied!
                    </span>
                )}
            </button>
