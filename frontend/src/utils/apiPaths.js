...
export const BASE_URL = import.meta.env.VITE_API_URL || "https://prep-zen-ai.vercel.app/";
...
export const API_PATHS = {
  ...
  AI: {
    GENERATE_QUESTIONS: "/api/ai/generate-questions",     // Generate interview questions using Gemini
    GENERATE_EXPLANATION: "/api/ai/generate-explanation", // Generate concept explanations using Gemini
  },
