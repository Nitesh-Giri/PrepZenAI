...
const SummaryCard = ({
  ...
  return (
    <div
      className="bg-white border border-gray-300/40 rounded-xl p-2 ovderflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group"
      onClick={onSelect}
    >
        <div 
        ...
        <div className="px-3 pb-3">
            ...
            <p className="text-[12px] text-gray-500 font-medium line-clamp-3 mt-3">
                {desciption}
            </p>
